...
export default function AnalysisPage() {
  ...
  const { currentListing, runAnalysis, setAnalysisResult, refreshHistory } = useApp();
  ...
  useEffect(() => {
    if (currentStage >= STAGES.length) {
      const run = async () => {
        const result = await runAnalysis(currentListing || {});
  ...
  }, [currentStage, currentListing, runAnalysis, setAnalysisResult, refreshHistory]);
